      ...
      <main className="pt-16">
          ...
          <div className="container mx-auto px-4 py-16 grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <motion.p 
                ...
                variants={fadeInUp}
              >
                I am a Python Developer with over 2 years of experience in
                designing and building scalable server-side applications and APIs using Python (Django/FastAPI). My expertise includes optimizing database queries, implementing secure authentication/authorization, and integrating third-party services.
              </motion.p>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              <motion.p className={`mb-6 text-lg ${darkMode ? 'text-gray-300' : 'text-gray-700'}`} variants={fadeIn}>
                I'm a Python Developer based in Indore, India, with over 2
                years of professional experience in building scalable server-side applications and APIs. I specialize in backend development, with expertise in technologies like
                Python (Django/FastAPI), MySQL, and basic frontend skills in JavaScript, HTML5, and CSS3.
              </motion.p>
              <motion.p className={`mb-6 text-lg ${darkMode ? 'text-gray-300' : 'text-gray-700'}`} variants={fadeIn}>
                Currently working at Fiftyfive Technologies, where I’m contributing to the design and development of robust back-end systems using Python (Django/FastAPI), RESTful APIs, and secure database architectures. Previously at Sofmen Technologies, I've contributed to
                several real-world projects including Bumble Roofing, Franchisee Management System, Wallaby Windows, One Stop Jewellery, FFTL, and Koala Insulation, where
                I developed scalable backends, integrated secure RESTful APIs, and optimized performance.
              </motion.p>
              <motion.p className={`text-lg ${darkMode ? 'text-gray-300' : 'text-gray-700'}`} variants={fadeIn}>
                I'm passionate about continuous learning, exploring emerging
                technologies, and solving complex problems with scalable, secure
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <motion.div 
                className={`relative border-l-2 border-indigo-500 pl-8 pb-8 ml-4 ${darkMode ? 'bg-gray-800/50 shadow-lg shadow-indigo-500/10' : 'bg-white/50 shadow-lg'} rounded-xl p-6 backdrop-blur-sm mt-8`}
                variants={fadeInUp}
              >
                <motion.div 
                  className="absolute w-4 h-4 bg-indigo-500 rounded-full -left-[9px] top-0"
                ...
                <div className="mb-6">
                  ...
                  >
                    {[
                      ...
                      "Improved API response time by 30% through optimized database queries in MySQL."
                    ].map((item, index) => (
                      <motion.p key={index} variants={fadeIn}>
                        • {item}
                      </motion.p>
              ...
              <motion.div variants={fadeInUp}>
                <Card className={`overflow-hidden ${darkMode ? 'bg-gray-800/50 border-gray-700 shadow-lg shadow-indigo-500/10' : 'bg-white shadow-lg'} rounded-xl backdrop-blur-sm transition-all duration-300 hover:shadow-xl`}>
                  <CardContent className="p-6">
                    ...
                    <p className={`italic mb-4 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Master of Computer Applications (MCA) • 2021 – 2023 • CGPA: 8.53
                    </p>
                    <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                      Completed my Master's degree with a focus on computer science.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                <Card className={`overflow-hidden ${darkMode ? 'bg-gray-800/50 border-gray-700 shadow-lg shadow-indigo-500/10' : 'bg-white shadow-lg'} rounded-xl backdrop-blur-sm transition-all duration-300 hover:shadow-xl`}>
                  <CardContent className="p-6">
                    ...
                    <p className={`italic mb-4 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Bachelor of Computer Applications (BCA) • 2018 – 2021 • CGPA: 7.3
                    </p>
                    <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                      Studied Computer Science with a focus on software
                      development and web technologies.
              ...
              <Card className={`overflow-hidden ${darkMode ? 'bg-gray-800/50 border-gray-700 shadow-lg shadow-indigo-500/10' : 'bg-white shadow-lg'} rounded-xl backdrop-blur-sm transition-all duration-300`}>
                <CardContent className="p-8">
                  ...
                  >
                    <motion.div variants={fadeInUp}>
                      <h3 className="text-xl font-bold text-indigo-400 mb-6 flex items-center">
                        <Code className="mr-2" /> Frontend (Basic)
                      </h3>
                      <div className="space-y-5">
                        {[
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-3">
                      {[
                        ...
                        "Postman", "API Integration", "Database Design", 
                        "Problem Solving"
                      ].map((skill, index) => (
                        <Badge 
                          key={index} 
