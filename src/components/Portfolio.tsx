...
import { PortfolioData } from "@/data/phpPortfolioData";
...
const Portfolio = ({ data }: PortfolioProps) => {
  ...
  return (
    <div
      className={`min-h-screen font-sans transition-colors duration-300 ${darkMode ? "dark bg-gray-900 text-white" : "bg-white text-gray-900"}`}
    >
      {/* Header/Navigation */}
      <header
      ...
      <main className="pt-16">
        ...
        >
          <div
            className={`absolute inset-0 ${darkMode ? "bg-gradient-to-br from-indigo-950/40 to-gray-900" : "bg-gradient-to-br from-indigo-100/40 to-white/60"} -z-10`}
          />
          ...
          <div className="container mx-auto px-4 py-16 grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-indigo-500">{data.name}</span>
              </motion.h1>
              ...
              <motion.div className="flex space-x-4 mt-8" variants={fadeInUp}>
                <motion.a
          ...
          <div className="container mx-auto px-4">
            ...
            >
              {data.experience.map((exp, expIndex) => (
                <motion.div
                  key={expIndex}
                  className={`relative border-l-2 border-indigo-500 pl-8 pb-8 ml-4 ${darkMode ? "bg-gray-800/50 shadow-lg shadow-indigo-500/10" : "bg-white/50 shadow-lg"} rounded-xl p-6 backdrop-blur-sm ${expIndex > 0 ? "mt-8" : ""}`}
                  variants={fadeInUp}
                >
                  <motion.div
                  ...
                  <div className="mb-6">
                    ...
                    <p
                      className={`italic mb-4 ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                    >
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <motion.div variants={fadeInUp}>
                <Card
                  className={`overflow-hidden ${darkMode ? "bg-gray-800/50 border-gray-700 shadow-lg shadow-indigo-500/10" : "bg-white shadow-lg"} rounded-xl backdrop-blur-sm transition-all duration-300 hover:shadow-xl`}
                >
                  <CardContent className="p-6">
                    ...
                    >
                      Completed my Master degree with a focus on computer
                      science.
                    </p>
                  </CardContent>
                </Card>
            ...
            >
              {data.projects.map((project, index) => (
                <motion.div key={index} variants={fadeInUp}>
                  <Card
                    className={`overflow-hidden h-full ${darkMode ? "bg-gray-800/50 border-gray-700 shadow-lg shadow-indigo-500/10" : "bg-white shadow-lg"} rounded-xl backdrop-blur-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1`}
                  >
                    <CardContent className="p-6 h-full flex flex-col">
                      ...
                      {project.date && (
                        <p
                          className={`${darkMode ? "text-gray-400" : "text-gray-500"} italic mb-4`}
                        >
                          {project.date}
                        </p>
                      )}
                      <p
                        className={`${darkMode ? "text-gray-300" : "text-gray-700"} mb-4 flex-grow`}
                      >
                        {project.description}
                      </p>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              <Card
                className={`overflow-hidden ${darkMode ? "bg-gray-800/50 border-gray-700 shadow-lg shadow-indigo-500/10" : "bg-white shadow-lg"} rounded-xl backdrop-blur-sm transition-all duration-300`}
              >
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <motion.div variants={fadeInUp} className="w-full max-w-4xl">
                <Card
                  className={`h-full ${darkMode ? "bg-gray-800/50 border-gray-700 shadow-lg shadow-indigo-500/10" : "bg-white shadow-lg"} rounded-xl backdrop-blur-sm`}
                >
      ...
      >
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p>
              &copy; {new Date().getFullYear()} Dinesh Rao. All rights reserved.
            </p>
          </div>
